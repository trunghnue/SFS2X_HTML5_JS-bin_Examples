...
{
	// We have to check if we are online because this listener is triggered when
	// the states list is populated on Buddy List initialization (and if we are offline, trying to set this variable causes an error)
	if (sfs.buddyManager.getMyOnlineState())
	{
