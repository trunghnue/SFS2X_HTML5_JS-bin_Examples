...
function setStarshipState(userId, x, y, vx, vy, direction, thrust, rotation, fireClientEvent)
{
	...
	if (user != null)
	{
		...
		var vars = [
			new SFSUserVariable(UV_X, x, VariableType.DOUBLE),
			new SFSUserVariable(UV_Y, y, VariableType.DOUBLE),
			new SFSUserVariable(UV_VX, vx, VariableType.DOUBLE),
			new SFSUserVariable(UV_VY, vy, VariableType.DOUBLE),
			new SFSUserVariable(UV_DIR, direction, VariableType.DOUBLE),
