// Import SFS2X namespace from API library
import * as SFS2X from "sfs2x-api";

// NOTE
// We can also import classes directly, for example: import {SmartFox} from "../lib/sfs2x-api-1.7.10";
// In this case we have to instantiate them withot the SFS2X prefix; foe example: sfs = new SmartFox(config);


// Set global reference to the SmartFox class instance
var sfs;

// Add listeners to UI buttons
document.getElementById("connectBt").onclick = onConnectBtClick;
document.getElementById("disconnectBt").onclick = onDisconnectBtClick;
